...
export default function Category() {
    ...
    const category=[
        ...
        },
        {
            id:6,
            name:"Desserts",
            image:<CiIceCream  className='w-[40px] h-[40px] text-green-300'/>
        }
    ]
  return (
   <div className='flex flex-wrap justify-center items-center gap-5 w-full'>
    {category.map((item)=>{
     return  <div className='w-[140px] h-[120px] bg-amber-50 flex flex-col items-center gap-5 shadow-md rounded-2xl text-shadow-lg hover:bg-emerald-400 cursor-pointer transition-all duration-500' >
